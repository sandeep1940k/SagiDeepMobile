...
/**
 * Footer promo: POST to **`SAGIDEEP_MOBILE_UPDATES`** (`footerPromoSheet.js`, `GlobalFooter.vue`).
 * Script should return JSON: **`mobileUpdateVideoLink`**, **`isMobileUpdate`**, **`subscribes`**.
...
/** If empty, IP tracking uses **`SAGIDEEP_TRACKING`** (`sheetClickIpTrack.js`). */
